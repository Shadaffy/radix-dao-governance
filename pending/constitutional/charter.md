...
3. **The Activation Vote** — the sole binding governance vote of the Advisory Governance Period, whose voting period, quorum, majority, and failure handling are specified in the **DAO Parameters Registry** and **Elections & Role Governance Policy** (**Operating Agreement §§1.4, 8.6**).

### 4A.3 Activation Conditions

The Activation Conditions are set out in **Operating Agreement Schedule 5** and may be supplemented by conditions specified in this Charter and the policy framework. The handover conditions referred to in Operating Agreement Schedule 5 (condition 10) are those specified in this Charter and the **RAC Mandate**.
